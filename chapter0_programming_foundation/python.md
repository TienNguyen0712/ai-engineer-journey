...
- [1.1 Nền tảng Python](#11-nen-tang-python)
  - [Kiểu dữ liệu & Biến](#kieu-du-lieu--bien)
  - [Chuỗi (String)](#chuoi-string)
  - [Collection (Tập hợp)](#collection-tap-hop)
  - [Control Flow](#control-flow)
- [1.2 Function (Hàm)](#12-function-ham)
- [1.3 OOP (Hướng đối tượng)](#13-oop-huong-doi-tuong)
- [1.4 Pythonic Code](#14-pythonic-code)
- [1.5 File Handling](#15-file-handling)
- [1.6 Sửa lỗi & Debugging](#16-sua-loi--debugging)
- [1.7 Hiệu suất và Bộ nhớ](#17-hieu-suat-va-bo-nho)
- [1.8 NumPy (Nền tảng tính toán mảng)](#18-numpy-nen-tang-tinh-toan-mang)
- [1.9 Pandas (Xử lý dữ liệu bảng)](#19-pandas-xu-ly-du-lieu-bang)
- [1.10 Code Quality & Cấu trúc Dự án](#110-code-quality--cau-truc-du-an)
- [1.11 Python cho AI Workflows](#111-python-cho-ai-workflows)
- [1.12 Async Python](#112-async-python)

---

<a id="11-nen-tang-python"></a>
## 1.1 Nền tảng Python
